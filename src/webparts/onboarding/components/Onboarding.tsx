...
const styles: Record<string, React.CSSProperties> = {
  ...
  segBtn: { padding: "8px 18px", fontSize: 13, fontFamily: "Arial, sans-serif", cursor: "pointer", background: "#fff", color: "#555", border: "none", borderRight: "1px solid #d0d0d0" },
  ...
  input: { padding: "7px 10px", border: "1px solid #c8c8c8", borderRadius: 4, fontFamily: "Arial, sans-serif", fontSize: 13, boxSizing: "border-box", width: "100%" },
  nameInput: { flex: "0 0 260px" },
  select: { flex: "0 0 150px", padding: "7px 8px", border: "1px solid #c8c8c8", borderRadius: 4, fontSize: 13, fontFamily: "Arial, sans-serif", background: "#fff", height: 34 },
  removeFolderBtn: { marginLeft: "auto", background: "none", border: "none", color: "#a4262c", cursor: "pointer", fontSize: 12, fontFamily: "Arial, sans-serif" },
  ...
  addBtn: { background: "none", border: "1px dashed #0f6c3f", color: "#0f6c3f", borderRadius: 4, padding: "7px 14px", fontSize: 13, cursor: "pointer", fontFamily: "Arial, sans-serif" },
  ...
  btn: { padding: "9px 26px", borderRadius: 4, cursor: "pointer", fontFamily: "Arial, sans-serif", fontSize: 13 },
  ...
  modal: { background: "#fff", borderRadius: 8, padding: "28px 32px", maxWidth: 520, width: "90%", boxShadow: "0 8px 40px rgba(0,0,0,.22)", fontFamily: "Arial, sans-serif" },
