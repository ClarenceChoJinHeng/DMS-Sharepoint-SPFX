...
const s: Record<string, React.CSSProperties> = {
  wrap:       { maxWidth: 720, margin: "32px auto", padding: "0 24px 48px", fontFamily: "Arial, sans-serif" },
  ...
  segBtn:     { padding: "8px 22px", fontSize: 13, fontFamily: "Arial, sans-serif", fontWeight: 600, cursor: "pointer", background: "#fff", color: "#0f6c3f", border: "none", borderRight: "1px solid #0f6c3f" },
  ...
  deleteBtn:  { background: "none", border: "none", color: "#a4262c", cursor: "pointer", fontSize: 12, fontFamily: "Arial, sans-serif", padding: "4px 8px" },
  ...
  select:     { padding: "7px 10px", border: "1px solid #c8c8c8", borderRadius: 4, fontFamily: "Arial, sans-serif", fontSize: 13, background: "#fff", minWidth: 190 },
  input:      { padding: "7px 10px", border: "1px solid #c8c8c8", borderRadius: 4, fontFamily: "Arial, sans-serif", fontSize: 13, width: 200 },
  addBtn:     { padding: "7px 20px", background: "#0f6c3f", color: "#fff", border: "none", borderRadius: 4, fontFamily: "Arial, sans-serif", fontSize: 13, fontWeight: 600, cursor: "pointer" },
